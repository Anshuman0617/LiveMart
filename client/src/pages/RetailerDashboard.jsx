...
export default function RetailerDashboard() {
  ...
  const filterAndSearch = useCallback(
    debounce((query, productList, discountedOnly) => {
  ...
  useEffect(() => {
    filterAndSearch(searchQuery, products, showDiscountedOnly);
  }, [searchQuery, products, showDiscountedOnly, filterAndSearch]);
